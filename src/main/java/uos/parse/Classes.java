...
public interface Classes {
	...
	/**
	 * Set {@link Methods}
	 * @param methods method to add method list of the class.
	 */
	public void setMethod( Methods methods );
	
	/**
	 * Return {@link Methods}
	 * @param index index of method in method-list of the class.
	...
	/**
	 * Return {@link Methods}
	 * @param methodName name of method in method-list of the class.
	 * @return method instance which specified.
	 */
	 ...
	 * @param index index of method to remove from method-list of the class.
	 */
	public void removeMethod( int index );
	
	/**
	 * Remove method from method-list of the class.
	 * @param methods method to remove from method-list of the class.
	 */
	...
	/**
	 * Set {@link Members}
	 * @param members member to add member-list of the class
	 */
	public void setMember( Members members );
	
	/**
	 * Return {@link Members} in class member-list
	 * @param index index of member in class member-list
	...
	/**
	 * Return {@link Members} in class member-list
	 * @param memberName name of member in class member-list
	 * @return member in the class member-list
	 */
	 ...
	 * @param index index of member-list of the class 
	 */
	public void removeMember( int index );
	
	/**
	 * Remove member in member-list of the class 
	 * @param members member in member-list of the class
	 */
