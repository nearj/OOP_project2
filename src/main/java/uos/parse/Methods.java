...
public interface Methods {
	...
	/**
	 * Set name of parameter and type. Since one method can has plular
	 * parameters, each parameter will be set as map with unique name.
	 * 
	 ...
	 * 
	 * @param members setting {@link Members}
	 */
	 ...
	 * @param memberName name of member in method member-list
	 ...
	 * 
	 * @param index index fo member to delete.
	 */
	 ...
	 * 
	 * @param members member to delete
	 */
